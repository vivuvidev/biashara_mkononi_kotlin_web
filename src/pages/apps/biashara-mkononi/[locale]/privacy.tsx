...
const meta: Record<Locale, { title: string; description: string }> = {
  en: {
    ...
    description: "FlavixLabs privacy policy for BiasharaMkononi POS.",
  },
  sw: {
    title: "Sera ya Faragha",
    description: "Sera ya faragha ya FlavixLabs kwa BiasharaMkononi POS.",
  },
};
...
export const getStaticProps = (async ({ params }) => {
  ...
  const file = locale === "sw" ? "privacy-policy-sw.md" : "privacy-policy.md";
...
export default function PrivacyPage({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Seo title={title} description={description} path={`${base}/privacy`} />
      <Navbar />
        ...
        <SectionWrapper>
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-8 border-b border-border pb-4">
              ...
              <Link
                href={`/apps/biashara-mkononi/${altLocale}/privacy`}
